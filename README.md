...
| **Official connector contract**   | Run Fedlex, Parliament, and court adapters through the same versioned discovery, metadata, expression, artifact, relation, and health boundary. Persist safe page checkpoints and idempotent receipts, retain attribution and raw provenance, and report source drift as degraded without inventing unchanged or repealed records.                                                                                |
