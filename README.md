...
| ---------------------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Web app                      | **Next.js**                                    | Implemented with registry, impact inbox, login, organization, evidence, comparison, model, prompt, and diagnostic views. Five-language localization remains public-beta work.                                                                                                  |
