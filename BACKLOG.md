...
| Five-step legal monitoring profiles | [Reference analysis and acceptance](docs/LEGAL_MONITORING_PROFILES.md) | H26-07 VERIFYING — Context → Topics → Sources → Delivery → Activate, connected to persisted monitoring |
