...
class RegulatoryEvent(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_regulatory_event_work_latest", "work_id", "detected_at", "id"),
...
ORGANIZATION_SCOPED_MODELS = (
    ...
    auction_workflow_models.AuctionReminder,
    auction_workflow_models.AuctionEmailPolicy,
    auction_workflow_models.AuctionDelivery,
