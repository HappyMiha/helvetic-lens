...
class BusinessMonitorScopeEvent(Base):
    ...
    action: Mapped[str] = mapped_column(String(20), default="scope", server_default="scope")
    previous_owner_user_id: Mapped[str | None] = mapped_column(ForeignKey("users.id", ondelete="SET NULL"))
