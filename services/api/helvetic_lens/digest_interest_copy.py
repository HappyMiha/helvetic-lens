"""Transactional copy for saved-interest digests; never an AI-generated notice."""
...
MESSAGES = {
    "en-CH": {
        ...
        "selection": "Topic-only and directly watched events without an impact assessment require Unknown, or no severity filter. No new AI request is made.",
    ...
    "de-CH": {
        ...
        "selection": "Thementreffer und direkt überwachte Ereignisse ohne Auswirkungsbewertung erfordern Unbekannt oder keinen Schweregradfilter. Es erfolgt keine neue KI-Anfrage.",
    ...
    "fr-CH": {
        ...
        "selection": "Les correspondances thématiques et événements surveillés sans évaluation d’impact nécessitent Inconnu ou aucun filtre de gravité. Aucune nouvelle requête IA.",
    ...
    "it-CH": {
        ...
        "selection": "Le corrispondenze tematiche e gli eventi monitorati senza valutazione d’impatto richiedono Sconosciuto o nessun filtro di gravità. Nessuna nuova richiesta IA.",
        "open_list": "Apri Oggi",
    ...
    "rm-CH": {
        ...
        "selection": "Correspundenzas tematicas ed eveniments survegliads senza valitaziun da l’effect dovran Nunenconuschent u nagin filter da gravitad. Nagina nova dumonda IA.",
        "open_list": "Avrir Oz",
        "event_limit": "Questa resumaziun è limitada a 50 eveniments. Avra Oz per tut ils interess actuals u restrenscha las funtaunas e la gravitad.",
    },
}
