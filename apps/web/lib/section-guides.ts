...
export const SECTION_GUIDES: SectionGuide[] = [
  ...
  },
  {
    ...
    purpose:
      "Compare owner-private warning, water and road events while retaining independent authority identities and reviews. A possible relationship never establishes common cause.",
    first: [
      "Choose events from at least two source sections and check their relationship.",
      "A positive group needs reviewed geography and explicit overlapping source times for every pair.",
    ],
    data: [
      "Only exact event references and association provenance are saved; source evidence is rechecked on every read.",
      "Missing rights, expired evidence, corrections and unavailable geographic bindings make the relationship unverified, never safe.",
    ],
    wait: "Reads and saves use local retained evidence. Grouping does not collect sources, send mail or change source reviews.",
    setup:
      "Create source monitors first. Platform administrators can review exact source features against the current official municipality edition using permitted geographic evidence.",
    controls: [
      refresh,
      pages,
      c(
        "members",
        "Choose events / Check relationship",
        "Selects at most twelve exact event references and checks every pair without saving.",
        "Choose permitted source events; missing location or time is explained.",
        "Edit draft",
      ),
      c(
        "save",
        "Save group / Edit group / Split",
        "Saves a private version. Removing a member leaves its original source event intact. No reviews or deliveries transfer.",
        "Requires management access, the current story version and freshly verified members.",
        "Save a change",
        undefined,
        "manager",
      ),
      c(
        "history",
        "Revision history / Use these members",
        "Reads historical membership; reusing it creates a new checked revision rather than rewriting history.",
        "Refresh changed source versions before saving.",
        "Read / navigate",
      ),
      c(
        "archive",
        "Archive / Restore",
        "Changes private story visibility. Restoring does not renew old source rights or relationship evidence.",
        "Requires management access and the current story version.",
        "Save a change",
        undefined,
        "manager",
      ),
      c(
        "binding",
        "Review geographic binding / Revoke",
        "Records or revokes an explicit exact-feature-to-municipality review; does not grant source permissions.",
        "Platform administrators need permitted evidence, its hash and a current official boundary edition. Names and time proximity are insufficient.",
        "Save a change",
        undefined,
        "platform",
      ),
  ...
  },
  {
    ...
    purpose:
      "Review the private email schedule and consent of one saved monitor across all nine directions.",
    first: [
      "Choose a direction and a saved monitor.",
      "Open its delivery preferences and review the current schedule.",
      "Explicitly confirm and save any email change.",
    ],
    data: [
      "Current private monitor settings and native email policy revisions.",
      "Preview uses current delivery rules and sends nothing.",
    ],
    wait: "Opening or refreshing reads saved settings; it does not collect sources or send email.",
    setup:
      "Pollen must be paused explicitly before schedule edits and resumed separately. Email consent and source availability remain separate.",
    controls: [
      refresh,
      pages,
      c(
        "choose",
        "Choose a saved monitor",
        "Opens only the selected monitor's native private email editor.",
        "Choose the owner-private monitor whose delivery you want to change.",
      ),
      c(
        "save",
        "Save email preferences",
        "Stores the reviewed schedule and explicit consent using the current native revision.",
        "Email needs verified ownership and explicit consent; saving does not activate monitoring.",
        "Save a change",
        undefined,
        "manager",
      ),
      c(
        "pollen-pause",
        "Pause / Resume Pollen monitoring",
        "Explicitly pauses collection before schedule edits or resumes after current source checks.",
        "Saving keeps monitoring paused; resumption and email consent require separate choices.",
        "Start background work",
        undefined,
        "manager",
      ),
