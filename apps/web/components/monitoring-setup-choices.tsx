...
export function MonitoringSetupChoices({ context, onTopic, topicDisabled, onLeave }: {
  ...
  return (
    <section data-monitor-choices className="my-4" aria-label={t("monitorChoice.title")}>
      <h3 className="mb-3">{t("monitorChoice.title")}</h3>
      <div className="grid gap-3 xl:grid-cols-3">
        <article className="rounded-lg border p-4 flex flex-col gap-2" data-monitor-choice="topic">
          <h4 className="font-semibold flex items-center gap-2"><Radar size={18} />{t("monitorChoice.topic")}</h4>
        ...
        <article className="rounded-lg border p-4 flex flex-col gap-2" data-monitor-choice="document">
          <h4 className="font-semibold flex items-center gap-2"><BookOpen size={18} />{t("monitorChoice.document")}</h4>
        ...
        <article className="rounded-lg border p-4 flex flex-col gap-2" data-monitor-choice="pack">
          <h4 className="font-semibold flex items-center gap-2"><PackageOpen size={18} />{t("monitorChoice.pack")}</h4>
