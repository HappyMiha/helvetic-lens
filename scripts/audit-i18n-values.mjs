...
const approvedIdentical = {
  "de-CH": new Set(["common.optional", "scan.apertus", "settings.infomaniak", "settings.topP", "prompts.ask", "models.revision", "logs.integration", "logs.provider.website", "logs.provider.fedlex", "logs.provider.firecrawl", "logs.provider.infomaniak", "org.team", "org.prompts", "org.revision", "status.live"]),
  ...
  "it-CH": new Set(["login.password", "sources.section", "scan.apertus", "settings.database", "settings.infomaniak", "settings.topP", "logs.provider.fedlex", "logs.provider.firecrawl", "logs.provider.infomaniak", "admin.backup", "law.file", "compare.area"]),
  "rm-CH": new Set(["history.context", "monitor.document", "scan.apertus", "settings.infomaniak", "settings.model", "settings.topP", "logs.success", "logs.provider.website", "logs.provider.fedlex", "logs.provider.firecrawl", "logs.provider.infomaniak", "org.local", "org.prompts", "org.quotas"]),
};
let failed = false;
