...
- A fluent German reviewer must approve the German catalogue and local-model wording.
- A fluent French reviewer must approve the French catalogue and local-model wording.
