...
| C4 — митний FX | XML існує, але на сторінці явне обмеження SIX на використання/розповсюдження третіми особами | **Заблокувати ingestion/redistribution до документованого права на використання**; не називати джерело open data |
...
## C4 — BAZG customs exchange rates
...
**Планування.** Це source-rights blocker, не engineering blocker і не доказ, що XML непридатний технічно. До письмового дозволу/ліцензії Helvetic Lens може мати лише перехід до офіційного джерела, без обіцянки автоматизованого FX monitor на цих даних. Discovery result: право одержання, зберігання, показу, threshold alerts, commercial redistribution, export, history; відповідальний і вартість. Ліцензований альтернативний курс не можна непомітно називати митним курсом BAZG. Після gate потрібні base/quote currency, unit multiplier, value date, effective date та non-trading-day semantics; це різні поняття.
