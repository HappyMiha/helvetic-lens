...
| H26-08 | Switch every organization and generative product workload to Swisscom Apertus 70B | [Rollout scope and evidence](../SWISSCOM_ALL_ORGANIZATIONS.md): existing and future organizations, API and workers, Marvin routing/disclosure, private credentials and history, concurrent real-provider checks, production 8ec8884 verified for seven organizations and four concurrent live requests | DONE |
| H26-09 | Show an independent maintenance page while the host is off | [Scope and acceptance](../EDGE_MAINTENANCE.md): original artwork and public cloud page; root/www routes; 24 September 08:00 CEST; six Worker tests; real tunnel-off test and automatic recovery of git-1357c738021b verified | DONE |
